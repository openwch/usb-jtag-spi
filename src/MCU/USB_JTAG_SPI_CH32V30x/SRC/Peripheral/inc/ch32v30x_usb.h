...
#define R32_USB_CONTROL     (*((PUINT32V)(0x50000000))) // USB control & interrupt enable & device address
#define R8_USB_CTRL         (*((PUINT8V)(0x50000000)))  // USB base control
#define     RB_UC_HOST_MODE     0x80      // enable USB host mode: 0=device mode, 1=host mode
#define     RB_UC_LOW_SPEED     0x40      // enable USB low speed: 0=12Mbps, 1=1.5Mbps
#define     RB_UC_DEV_PU_EN     0x20      // USB device enable and internal pullup resistance enable
#define     RB_UC_SYS_CTRL1     0x20      // USB system control high bit
...
#define R8_UDEV_CTRL        (*((PUINT8V)(0x50000001)))  // USB device physical prot control
#define     RB_UD_PD_DIS        0x80      // disable USB UDP/UDM pulldown resistance: 0=enable pulldown, 1=disable
#define     RB_UD_DP_PIN        0x20      // ReadOnly: indicate current UDP pin level
#define     RB_UD_DM_PIN        0x10      // ReadOnly: indicate current UDM pin level
#define     RB_UD_LOW_SPEED     0x04      // enable USB physical port low speed: 0=full speed, 1=low speed
...
#define R8_USB_INT_EN       (*((PUINT8V)(0x50000002)))  // USB interrupt enable
#define     RB_UIE_DEV_SOF      0x80      // enable interrupt for SOF received for USB device mode
#define     RB_UIE_DEV_NAK      0x40      // enable interrupt for NAK responded for USB device mode
#define     RB_UIE_FIFO_OV      0x10      // enable interrupt for FIFO overflow
#define     RB_UIE_HST_SOF      0x08      // enable interrupt for host SOF timer action for USB host mode
...
#define R8_USB_DEV_AD       (*((PUINT8V)(0x50000003)))  // USB device address
#define     RB_UDA_GP_BIT       0x80      // general purpose bit
#define     MASK_USB_ADDR       0x7F      // bit mask for USB device address

#define R32_USB_STATUS      (*((PUINT32V)(0x50000004))) // USB miscellaneous status & interrupt flag & interrupt status
#define R8_USB_MIS_ST       (*((PUINT8V)(0x50000005)))  // USB miscellaneous status
#define     RB_UMS_SOF_PRES     0x80      // RO, indicate host SOF timer presage status
#define     RB_UMS_SOF_ACT      0x40      // RO, indicate host SOF timer action status for USB host
#define     RB_UMS_SIE_FREE     0x20      // RO, indicate USB SIE free status
#define     RB_UMS_R_FIFO_RDY   0x10      // RO, indicate USB receiving FIFO ready status (not empty)
...
#define R8_USB_INT_FG       (*((PUINT8V)(0x50000006)))  // USB interrupt flag
#define     RB_U_IS_NAK         0x80    // RO, indicate current USB transfer is NAK received
#define     RB_U_TOG_OK         0x40    // RO, indicate current USB transfer toggle is OK
#define     RB_U_SIE_FREE       0x20    // RO, indicate USB SIE free status
#define     RB_UIF_FIFO_OV      0x10    // FIFO overflow interrupt flag for USB, direct bit address clear or write 1 to clear
...
#define R8_USB_INT_ST       (*((PUINT8V)(0x50000007)))  // USB interrupt status
#define     RB_UIS_IS_NAK       0x80      // RO, indicate current USB transfer is NAK received for USB device mode
#define     RB_UIS_TOG_OK       0x40      // RO, indicate current USB transfer toggle is OK
#define     RB_UIS_TOKEN1       0x20      // RO, current token PID code bit 1 received for USB device mode
#define     RB_UIS_TOKEN0       0x10      // RO, current token PID code bit 0 received for USB device mode
...
#define R8_USB_RX_LEN       (*((PUINT8V)(0x50000008)))  // USB receiving length
#define R32_USB_BUF_MODE    (*((PUINT32V)(0x5000000c))) // USB endpoint buffer mode
#define R8_UEP4_1_MOD       (*((PUINT8V)(0x5000000c)))  // endpoint 4/1 mode
#define     RB_UEP1_RX_EN       0x80      // enable USB endpoint 1 receiving (OUT)
#define     RB_UEP1_TX_EN       0x40      // enable USB endpoint 1 transmittal (IN)
#define     RB_UEP1_BUF_MOD     0x10      // buffer mode of USB endpoint 1
// bUEPn_RX_EN & bUEPn_TX_EN & bUEPn_BUF_MOD: USB endpoint 1/2/3 buffer mode, buffer start address is UEPn_DMA
...
#define R8_UEP2_3_MOD       (*((PUINT8V)(0x5000000d)))  // endpoint 2/3 mode
#define     RB_UEP3_RX_EN       0x80      // enable USB endpoint 3 receiving (OUT)
#define     RB_UEP3_TX_EN       0x40      // enable USB endpoint 3 transmittal (IN)
#define     RB_UEP3_BUF_MOD     0x10      // buffer mode of USB endpoint 3
#define     RB_UEP2_RX_EN       0x08      // enable USB endpoint 2 receiving (OUT)
...
#define R8_UEP5_6_MOD       (*((PUINT8V)(0x5000000e)))  // endpoint 5/6 mode
#define RB_UEP6_RX_EN       0x80      // enable USB endpoint 6 receiving (OUT)
#define RB_UEP6_TX_EN       0x40      // enable USB endpoint 6 transmittal (IN)
#define RB_UEP6_BUF_MOD     0x10      // buffer mode of USB endpoint 6
#define RB_UEP5_RX_EN       0x08      // enable USB endpoint 5 receiving (OUT)
...
#define R8_UEP7_MOD         (*((PUINT8V)(0x5000000f)))  // endpoint 7 mode
#define RB_UEP7_RX_EN       0x08      // enable USB endpoint 7 receiving (OUT)
#define RB_UEP7_TX_EN       0x04      // enable USB endpoint 7 transmittal (IN)
#define RB_UEP7_BUF_MOD     0x01      // buffer mode of USB endpoint 7


#define R32_UEP0_DMA        (*((PUINT32V)(0x50000010))) // endpoint 0 DMA buffer address
#define R32_UEP1_DMA        (*((PUINT32V)(0x50000014))) // endpoint 1 DMA buffer address
#define R32_UEP2_DMA        (*((PUINT32V)(0x50000018))) // endpoint 2 DMA buffer address
#define R32_UH_RX_DMA       R32_UEP2_DMA                // host rx endpoint buffer high address
#define R32_UEP3_DMA        (*((PUINT32V)(0x5000001c))) // endpoint 3 DMA buffer address

#define R32_UEP4_DMA        (*((PUINT32V)(0x50000020))) // endpoint 4 DMA buffer address
#define R32_UEP5_DMA        (*((PUINT32V)(0x50000024))) // endpoint 5 DMA buffer address
#define R32_UEP6_DMA        (*((PUINT32V)(0x50000028))) // endpoint 6 DMA buffer address
#define R32_UEP7_DMA        (*((PUINT32V)(0x5000002c))) // endpoint 7 DMA buffer address

#define R32_UH_TX_DMA       R32_UEP3_DMA                // host tx endpoint buffer high address
#define R32_USB_EP0_CTRL    (*((PUINT32V)(0x50000030))) // endpoint 0 control & transmittal length
#define R8_UEP0_T_LEN       (*((PUINT8V)(0x50000030)))  // endpoint 0 transmittal length
#define R16_UEP0_CTRL       (*((PUINT16V)(0x50000032))) // endpoint 0 control
#define R8_UEP0_TX_CTRL     (*((PUINT8V)(0x50000032)))  // endpoint 0 control
#define R8_UEP0_RX_CTRL     (*((PUINT8V)(0x50000033)))  // endpoint 0 control
#define R32_USB_EP1_CTRL    (*((PUINT32V)(0x50000034))) // endpoint 1 control & transmittal length
#define R8_UEP1_T_LEN       (*((PUINT8V)(0x50000034)))  // endpoint 1 transmittal length
#define R16_UEP1_CTRL       (*((PUINT16V)(0x50000036))) // endpoint 0 control
#define R8_UEP1_TX_CTRL     (*((PUINT8V)(0x50000036)))  // endpoint 1 control
#define R8_UEP1_RX_CTRL     (*((PUINT8V)(0x50000037)))  // endpoint 1 control

#define RB_UEP_AUTO_TOG     0x08      // enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle
#define RB_UEP_R_TOG        0x04      // expected data toggle flag of USB endpoint X receiving (OUT): 0=DATA0, 1=DATA1
#define RB_UEP_T_TOG        0x04      // prepared data toggle flag of USB endpoint X transmittal (IN): 0=DATA0, 1=DATA1

#define RB_UEP_R_RES1       0x02      // handshake response type high bit for USB endpoint X receiving (OUT)
#define RB_UEP_R_RES0       0x01      // handshake response type low bit for USB endpoint X receiving (OUT)
#define MASK_UEP_R_RES      0x03      // bit mask of handshake response type for USB endpoint X receiving (OUT)
#define UEP_R_RES_ACK       0x00
#define UEP_R_RES_TOUT      0x01
...
#define R16_UH_SETUP        R16_UEP1_CTRL               // host aux setup
#define RB_UH_PRE_PID_EN    0x0400      // USB host PRE PID enable for low speed device via hub
#define RB_UH_SOF_EN        0x04        // USB host automatic SOF enable

#define R32_USB_EP2_CTRL    (*((PUINT32V)(0x50000038))) // endpoint 2 control & transmittal length
#define R8_UEP2_T_LEN       (*((PUINT8V)(0x50000038)))  // endpoint 2 transmittal length
#define R16_UEP2_CTRL       (*((PUINT16V)(0x5000003a))) // endpoint 2 control
#define R8_UEP2_TX_CTRL     (*((PUINT8V)(0x5000003a)))  // endpoint 2 tx control
#define R8_UEP2_RX_CTRL     (*((PUINT8V)(0x5000003b)))  // endpoint 2 rx control
...
#define RB_UH_R_AUTO_TOG    0x08      // enable automatic toggle after successful transfer completion: 0=manual toggle, 1=automatic toggle
#define RB_UH_R_TOG         0x04      // expected data toggle flag of host receiving (IN): 0=DATA0, 1=DATA1
#define RB_UH_R_RES         0x01      // prepared handshake response type for host receiving (IN): 0=ACK (ready), 1=no response, time out to device, for isochronous transactions

#define R32_USB_EP3_CTRL    (*((PUINT32V)(0x5000003c))) // endpoint 3 control & transmittal length
#define R8_UEP3_T_LEN       (*((PUINT16V)(0x5000003c))) // endpoint 3 transmittal length
#define R16_UEP3_CTRL       (*((PUINT16V)(0x5000003e))) // endpoint 3 control
#define R8_UEP3_TX_CTRL     (*((PUINT8V)(0x5000003e)))  // endpoint 3 tx control
#define R8_UEP3_RX_CTRL     (*((PUINT8V)(0x5000003f)))  // endpoint 3 rx control

#define R8_UH_TX_LEN        (*((PUINT16V)(0x5000003c))) //R8_UEP3_T_LEN             // host transmittal endpoint transmittal length

#define R8_UH_TX_CTRL       R8_UEP3_TX_CTRL             // host transmittal endpoint control
#define RB_UH_T_AUTO_TOG    0x08                    // enable automatic toggle after successful transfer completion: 0=manual toggle, 1=automatic toggle
#define RB_UH_T_TOG         0x04                    // prepared data toggle flag of host transmittal (SETUP/OUT): 0=DATA0, 1=DATA1
#define RB_UH_T_RES         0x01                    // expected handshake response type for host transmittal (SETUP/OUT): 0=ACK (ready), 1=no response, time out from device, for isochronous transactions

#define R32_USB_EP4_CTRL    (*((PUINT32V)(0x50000040))) // endpoint 4 control & transmittal length
#define R8_UEP4_T_LEN       (*((PUINT8V)(0x50000040)))  // endpoint 4 transmittal length
#define R16_UEP4_CTRL       (*((PUINT16V)(0x50000042))) // endpoint 4 control
#define R8_UEP4_TX_CTRL     (*((PUINT8V)(0x50000042)))  // endpoint 4 tx control
#define R8_UEP4_RX_CTRL     (*((PUINT8V)(0x50000043)))  // endpoint 4 rx control

#define R32_USB_EP5_CTRL    (*((PUINT32V)(0x50000044))) // endpoint 5 control & transmittal length
#define R8_UEP5_T_LEN       (*((PUINT8V)(0x50000044)))  // endpoint 5 transmittal length
#define R16_UEP5_CTRL       (*((PUINT16V)(0x50000046))) // endpoint 5 control
#define R8_UEP5_TX_CTRL     (*((PUINT8V)(0x50000046)))  // endpoint 5 tx control
#define R8_UEP5_RX_CTRL     (*((PUINT8V)(0x50000047)))  // endpoint 5 rx control

#define R32_USB_EP6_CTRL    (*((PUINT32V)(0x50000048))) // endpoint 6 control & transmittal length
#define R8_UEP6_T_LEN       (*((PUINT8V)(0x50000048)))  // endpoint 6 transmittal length
#define R16_UEP6_CTRL       (*((PUINT16V)(0x5000004a))) // endpoint 6 control
#define R8_UEP6_TX_CTRL     (*((PUINT8V)(0x5000004a)))  // endpoint 6 tx control
#define R8_UEP6_RX_CTRL     (*((PUINT8V)(0x5000004b)))  // endpoint 6 rx control

#define R32_USB_EP7_CTRL    (*((PUINT32V)(0x5000004c))) // endpoint 7 control & transmittal length
#define R8_UEP7_T_LEN       (*((PUINT8V)(0x5000004c)))  // endpoint 7 transmittal length
#define R16_UEP7_CTRL       (*((PUINT16V)(0x5000004e))) // endpoint 7 control
#define R8_UEP7_TX_CTRL     (*((PUINT8V)(0x5000004e)))  // endpoint 7 tx control
#define R8_UEP7_RX_CTRL     (*((PUINT8V)(0x5000004f)))  // endpoint 7 rx control
